    ...
    init{
        ...
        for (totem in data){
            val obj = Totem(
                ...
                id =  totem[3],
                name = totemClass[totem[4]]!![0],
                desc = totemClass[totem[4]]!![1],
                bitmapId = context.resources.getIdentifier(totemClass[totem[4]]!![2], "drawable", context.packageName),
                group = totemClass[totem[4]]!![3],
                maxHealth = totem[5],
                damage = totem[6],
                damageAir = totem[7],
                damageWater = totem[8],
                damageFire = totem[9],
                damageEarth = totem[10],
                defence = totem[11],
                defenceAir = totem[12],
                defenceWater = totem[13],
                defenceFire = totem[14],
                defenceEarth = totem[15],
            )
            totems.add(obj)
        }
    }
